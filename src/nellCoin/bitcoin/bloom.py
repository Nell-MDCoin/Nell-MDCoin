...
import struct
import math
from nellCoin.bitcoin.serialize import *
from nellCoin.bitcoin.coredefs import *
from nellCoin.bitcoin.core import *
from nellCoin.bitcoin.hash import MurmurHash3
...
class CBloomFilter(object):
    ...
    def IsRelevantAndUpdate(self, tx, tx_hash):
