...
from nellCoin.wallet.wallet import Wallet
from nellCoin import bitcoinrpc
from nellCoin.bitcoinrpc.exceptions import TransportException
from nellCoin.version import VERSION, COPYRIGHT_YEAR
...
def send(wallet):
    ...
    toaddress = input("Enter the address to send coins to: ")
...
def parse_arguments():
    ...
    parser.add_argument("config_file", nargs='?', default='~/.nellCoin.cfg')
