...
import hashlib
from nellCoin.bitcoin.serialize import Hash, Hash160, ser_uint256, ser_uint160
from nellCoin.bitcoin.script import *
from nellCoin.bitcoin.core import CTxOut, CTransaction
from nellCoin.bitcoin.key import CKey
from nellCoin.bitcoin.bignum import bn2vch, vch2bn
...
def VerifySignature(txFrom, txTo, inIdx, hashtype):
    ...
    if not VerifyScript(txin.scriptSig, txout.scriptPubKey, txTo, inIdx, hashtype):
        return False
